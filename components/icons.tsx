...
export const GiftIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v13m0-13V6a2 2 0 012-2h2a2 2 0 012 2v2m-6 0h6m-6 0H6a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2m0 0V8m0 13a2 2 0 002-2v-2a2 2 0 00-2-2h-2a2 2 0 00-2 2v2a2 2 0 002 2h2z" />
    </svg>
);
...
export const PalmTreeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 17h8m-4-11V3.134a1.134 1.134 0 00-1.134-1.134H11.134A1.134 1.134 0 0010 3.134V6m3 11v-5m-3 0v5m0-11a2.25 2.25 0 00-4.5 0v2.25a2.25 2.25 0 004.5 0V6zM6 17h2m4-5a2.25 2.25 0 00-4.5 0v2.25a2.25 2.25 0 004.5 0v-2.25z" />
    </svg>
);
...
export const GraduationCapIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v4.999c0 .64.246 1.213.67 1.637.425.424.997.67 1.63.67h1.4c.276 0 .5.224.5.5s-.224.5-.5.5h-1.4a2.5 2.5 0 01-2.5-2.5V6.253c0-1.353 1.424-2.453 3.16-2.453 1.42 0 2.68.733 3.34 1.554a.5.5 0 00.999-.001c.66-1.03 1.92-1.554 3.34-1.554 1.737 0 3.16 1.1 3.16 2.453v4.999c0 1.353-1.423 2.453-3.16 2.453-1.42 0-2.68-.733-3.34-1.554a.5.5 0 00-.999.001c-.66.82-1.92 1.324-3.34 1.324h-1.4c-.276 0-.5-.224-.5-.5s.224-.5.5-.5h1.4c.633 0 1.205-.246 1.63-.67.424-.424.67-.997.67-1.637V6.253z" />
    </svg>
);
...
export const DumbbellIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 12h16M6 8v8m12-8v8M4 8h2m12 0h2M4 16h2m12 0h2" />
    </svg>
);
